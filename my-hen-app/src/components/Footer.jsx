        ...
        <div className="row">
          ...
          <div className="col-md-4 mb-3">
            ...
            <ul className="list-unstyled">
              ...
              <li><Link to="/punju" className="text-light text-decoration-none">Roosters</Link></li>
              <li><Link to="/goat" className="text-light text-decoration-none">Goats</Link></li>
              <li><Link to="/buffalo" className="text-light text-decoration-none">Buffaloes</Link></li>
